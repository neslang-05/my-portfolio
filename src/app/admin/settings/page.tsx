      ...
      <div className="max-w-2xl space-y-8">
        ...
        <div className="border border-zinc-800 p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-sans text-zinc-400 mb-2">Admin Email</label>
              <input
                type="email"
                value={user?.email || ''}
                disabled
                className="w-full bg-zinc-900 border border-zinc-800 px-4 py-3 text-zinc-400 cursor-not-allowed font-sans"
              />
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between py-3 border-b border-zinc-900">
              ...
              <button
                onClick={handleSync}
                disabled={syncing}
                className="bg-zinc-800 text-white px-4 py-2 hover:bg-zinc-700 transition-colors flex items-center gap-2 disabled:opacity-50 font-sans"
              >
            ...
            <div className="flex items-center justify-between py-3 border-b border-zinc-900">
              ...
              <button
                ...
                className="bg-zinc-800 text-white px-4 py-2 hover:bg-zinc-700 transition-colors flex items-center gap-2 font-sans"
              >
            ...
            <div className="flex items-center justify-between py-3">
              ...
              <label className="bg-zinc-800 text-white px-4 py-2 hover:bg-zinc-700 transition-colors flex items-center gap-2 cursor-pointer font-sans">
        ...
        <div className="border border-zinc-800 p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-sans text-zinc-400 mb-2">Site Title</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-sans text-zinc-400 mb-2">Site Description</label>
              <textarea
                defaultValue="Computer Science Engineering Student | IoT Developer | Full Stack Web Developer"
                className="w-full bg-black border border-zinc-800 px-4 py-3 text-white focus:outline-none focus:border-zinc-600 h-20 font-sans"
              />
            </div>
          </div>
          <button className="mt-4 bg-white text-black px-4 py-2 font-bold hover:bg-zinc-200 transition-colors flex items-center gap-2 font-sans">
        ...
        <div className="border border-zinc-800 p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-bold text-white uppercase font-sans">Danger Zone</h2>
          </div>
          <div className="space-y-4">
            <div className="flex items-center justify-between py-3 border-b border-zinc-900">
              <div>
              ...
              <button className="bg-zinc-800 text-white border border-zinc-700 px-4 py-2 hover:bg-zinc-700 transition-colors flex items-center gap-2 font-sans">
