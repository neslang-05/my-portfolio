        ...
        <div className="px-6 py-8">
          ...
          <section className="mt-8">
            ...
            <p className="text-gray-600">
              I&apos;m a developer passionate about creating impactful solutions that seamlessly integrate robust engineering with thoughtful design. My expertise lies at the intersection of IoT, cloud computing, and web development, where I enjoy turning innovative ideas into practical applications.
              <br /><br />
          ...
          <section className="mt-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4" id="education">Education</h2>
